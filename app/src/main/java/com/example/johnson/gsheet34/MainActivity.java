package com.example.johnson.gsheet34;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Initialnize(); // initialnize the button, textview and google account.
        initializeEvents();

    }

    public void Initialnize(){
        //Button mCallApiButton = new <Button>

        mCallApiButton = (Button) findViewById(R.id.Btncall);
        mOutputText = (TextView) findViewById(R.id.TextViewSteps);
